...
function draw()
{
	...
	fill(255, 0, 128);
	ellipse(150, 265, 130, 130);
    fill(128, 0, 255);
	quad(70, 200, 30, 100, 50, 80, 90, 220);
	quad(200, 200, 300, 100, 320, 120);
    fill(0, 100, 200);
	rect(110, 330, 30, 110);
	rect(160, 330, 30, 110);
    ...
    fill(128, 0, 128);
	triangle(370, 200, 300, 200, 400, 250);
	triangle(500, 200, 600, 100, 500, 250);
    fill(128, 255, 0);
	ellipse(420, 330, 30, 110);
	rect(450, 330, 30, 110);
