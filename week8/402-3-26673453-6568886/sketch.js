...
Officer: 6568886
CaseNum: 402-3-26673453-6568886
...
function draw() {
	...
	else if (det.locationX > 197 && det.locationY > 385) {
		det.speedX = -1;
		det.speedY = 0;
	}
	else if (det.locationY > 385) {
		det.speedX = 0;
		det.speedY = -1;
	}
	else if (det.locationX < 574 && det.locationY > 260) {
		det.speedX = 1;
		det.speedY = 0;
	}
	...
	else if (det.locationX > 324 && det.locationY > 136) {
		det.speedX = -1;
		det.speedY = 0;
	}
	else if (det.locationY > 136) {
		det.speedX = 0;
		det.speedY = -1;
	}
	else if (det.locationX < 825 && det.locationY > 73) {
		det.speedX = 1;
		det.speedY = 0;
	}
	else if (det.locationY > 73) {
		det.speedX = 0;
		det.speedY = -1;
	}
	else if (det.locationX > 135) {
		det.speedX = -1;
		det.speedY = 0;
	}
	else {
