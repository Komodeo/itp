...
Officer: 6568886
CaseNum: 402-0-60529172-6568886
...
var det = {
	...
	"locationX": 73,
	"locationY": 73,
	"currentStreet": "Mullenweg Street",
	"image": "./det.png"
};
...
function draw() {
	///////////////////ADD YOUR CODE HERE///////////////////
	if (currentRoad == "Mullenweg Street" || currentRoad == "Ada Avenue") {
		direction = "east";
	}

	if (currentRoad == "Gosling Road" || currentRoad == "Crowther Road") {
		direction = "south";
	}
