...
Officer: 6568886
CaseNum: 402-1-19139840-6568886
...
function draw() {
	...
	if (currentRoad == "Gates Avenue" || currentRoad == "Huffman Street") {
		det.speedX = 1;
		det.speedY = 0;
	}

	if (currentRoad == "Crowther Road" || currentRoad == "Berners-lee Street") {
		det.speedX = 0;
		det.speedY = -1;
	}
