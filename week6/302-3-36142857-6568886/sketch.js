...
Officer: 6568886
CaseNum: 302-3-36142857-6568886
...
function draw()
{
	...
	spotlight1.x += spotlight1.xSpeed;
	spotlight1.y += spotlight1.ySpeed;

	spotlight2.x += spotlight2.xSpeed;
	spotlight2.y += spotlight2.ySpeed;

	spotlight3.x += spotlight3.xSpeed;
	spotlight3.y += spotlight3.ySpeed;
